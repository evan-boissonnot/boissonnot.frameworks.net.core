...
{
    /// <summary>
    /// Logger par défaut utilisant log4net
    /// </summary>
    public class Log4NetLogger : ILogger
    {
        ...
        public Log4NetLogger(string name, XmlElement xmlElement)
        {
            ...
            this._loggerRepository = log4net.LogManager.CreateRepository(
                Assembly.GetEntryAssembly(), typeof(log4net.Repository.Hierarchy.Hierarchy));
            this._log = LogManager.GetLogger(_loggerRepository.Name, name);
